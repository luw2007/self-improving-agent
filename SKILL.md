...
- 截止 2026-03-03，上游仓库未包含 LICENSE 文件或明确授权声明。
- 在缺少许可证时，应默认视为“保留所有权利”，不得在未获授权情况下再发布、分发、商业使用或对外共享本仓库内容（含镜像、复制粘贴到公开文档/仓库、打包发布等）。
- 允许的最低限度使用：仅限个人或组织内部的学习、评估与本地运行；不得向第三方提供拷贝或访问。
- 若上游后续补充 LICENSE，以新 LICENSE 为准；如需超出上述范围的使用，请联系上游作者获取书面许可。
